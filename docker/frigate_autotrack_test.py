"""Correlate Frigate relative zoom with Cuckoo and Finch PTZ traffic."""
...
def main() -> int:
    ...
    if autotracking.get("zooming") != "relative":
        raise SystemExit(
            f"relative zoom is required, got {autotracking.get('zooming')!r}"
        )
        ...
        try:
            ...
            if (
                ...
                evidence = {
                    ...
                    "frigate_relative_zoom_request": relative_zoom[0],
